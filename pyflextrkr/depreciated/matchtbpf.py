...
def identifypf_wrf_rain(
    ...
    for it in range(0, ir_ntracks):
        ...
        for itt in irindices:
            ...
            rainaccumulation_filename = (
                ...
                + rainaccumulation_filebase
                + "_"
                + ittdatetimestring[0:4]
                + "-"
                + ittdatetimestring[4:6]
                + "-"
                + ittdatetimestring[6:8]
                + "_"
                + ittdatetimestring[9:11]
                + ":"
                + ittdatetimestring[11:13]
                + ":00.nc"
            )
            ...
            if os.path.isfile(cloudid_filename) and os.path.isfile(
                rainaccumulation_filename
            ):
                count = 0
                print("Data Present")
                ...
                if ncloudpix > 0:
                    ...
                    if nrainpix > 0:
                        ...
                        dilatedbinarypfmap = binary_dilation(
                            binarypfmap, structure=dilationstructure, iterations=1
                        ...
                        if npf_new > 0:
                            ...
                            pforder = pforder[
                                ::-1
                            ]  # flips the order to largest to smallest
                            ...
                            pf_pfmajoraxis[it, itt, 0:npf_save] = spfmajoraxis[
                                0:npf_save
                            ]
                            pf_pfminoraxis[it, itt, 0:npf_save] = spfminoraxis[
                                0:npf_save
                            ]
                            pf_pfaspectratio[it, itt, 0:npf_save] = spfaspectratio[
                                0:npf_save
                            ]
                            pf_pforientation[it, itt, 0:npf_save] = spforientation[
                                0:npf_save
                            ]
                            pf_pfeccentricity[it, itt, 0:npf_save] = spfeccentricity[
                                0:npf_save
                            ]
                            pf_pfycentroid[it, itt, 0:npf_save] = spfycentroid[
                                0:npf_save
                            ]
                            pf_pfxcentroid[it, itt, 0:npf_save] = spfxcentroid[
                                0:npf_save
                            ]
                            pf_pfxweightedcentroid[
                                it, itt, 0:npf_save
                            ] = spfxweightedcentroid[0:npf_save]
                            pf_pfyweightedcentroid[
                                it, itt, 0:npf_save
                            ] = spfyweightedcentroid[0:npf_save]
    ...
    output_data.pf_frac.attrs[
        "long_name"
    ] = "fraction of cold cloud shielf covered by rainrate mask"
