...
#        logger.info('Determining mergers')
    ...
    def identifycell_WRF_xarray(statistics_filebase, stats_path, startdate, enddate, time_resolution, geolimits, maincloud_duration, merge_duration, split_duration, nmaxmerge):
    # Inputs:
    # statistics_filebase - header of the track statistics file that was generated in the previous code
    # stats_path - location of the track data. also the location where the data from this code will be saved
    # startdate - starting date and time of the data
...
def identifycell_WRF_netcdf4(statistics_filebase, stats_path, startdate, enddate, time_resolution, geolimits, maincloud_duration, merge_duration, split_duration, nmaxmerge):
    # Inputs:
    # statistics_filebase - header of the track statistics file that was generated in the previous code
    # stats_path - location of the track data. also the location where the data from this code will be saved
    # startdate - starting date and time of the data
