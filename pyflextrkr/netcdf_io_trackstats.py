...
def write_trackstats_radar(
    ...
    finaltrack_endstatus,  # finaltrack_endmergenumber, finaltrack_endcloudnumber, \
    ...
    finaltrack_cell_rangeflag,  # finaltrack_tracklength, finaltrack_basetime, \
    ...
    # Define variable list
    varlist = {
        "lifetime": ([trackdimname], finaltrack_tracklength),
        "basetime": (
    ...
    # Define coordinate list
    coordlist = {
        trackdimname: ([trackdimname], np.arange(0, numtracks)),
        timedimname: (
            [timedimname],
            np.arange(0, maxtracklength),
        ),  # 'nfilenamechars': (['nfilenamechars'], np.arange(0, numcharfilename)), \
        # 'ndatetimechars': (['ndatetimechars'], np.arange(0, 13)),\
    }
    ...
    output_data.lifetime.attrs[
        "comments"
    ] = "Multiply by time_resolution_hour to convert to physical units"
    ...
    output_data.core_meanlat.attrs[
        "long_name"
    ] = "Mean latitude of the convective core in a track"
    output_data.core_meanlat.attrs["units"] = "degrees_north"

    output_data.core_meanlon.attrs[
        "long_name"
    ] = "Mean longitude of the convective core in a track"
    output_data.core_meanlon.attrs["units"] = "degrees_east"

    output_data.core_mean_y.attrs[
        "long_name"
    ] = "Mean y-distance to radar for the convective core in a track"
    output_data.core_mean_y.attrs["units"] = "km"

    output_data.core_mean_x.attrs[
        "long_name"
    ] = "Mean x-distance to radar for the convective core in a track"
    output_data.core_mean_x.attrs["units"] = "km"

    output_data.cell_meanlat.attrs[
        "long_name"
    ] = "Mean latitude of the convective cell in a track"
    output_data.cell_meanlat.attrs["units"] = "degrees_north"

    output_data.cell_meanlon.attrs[
        "long_name"
    ] = "Mean longitude of the convective cell in a track"
    output_data.cell_meanlon.attrs["units"] = "degrees_east"

    output_data.cell_mean_y.attrs[
        "long_name"
    ] = "Mean y-distance to radar for the convective cell in a track"
    output_data.cell_mean_y.attrs["units"] = "km"

    output_data.cell_mean_x.attrs[
        "long_name"
    ] = "Mean x-distance to radar for the convective cell in a track"
    output_data.cell_mean_x.attrs["units"] = "km"

    output_data.cell_minlat.attrs[
        "long_name"
    ] = "Minimum latitude of the convective cell in a track"
    output_data.cell_minlat.attrs["units"] = "degrees_north"

    output_data.cell_minlon.attrs[
        "long_name"
    ] = "Minimum longitude of the convective cell in a track"
    output_data.cell_minlon.attrs["units"] = "degrees_east"

    output_data.cell_maxlat.attrs[
        "long_name"
    ] = "Maximum latitude of the convective cell in a track"
    output_data.cell_maxlat.attrs["units"] = "degrees_north"

    output_data.cell_maxlon.attrs[
        "long_name"
    ] = "Maximum longitude of the convective cell in a track"
    output_data.cell_maxlon.attrs["units"] = "degrees_east"

    output_data.cell_min_y.attrs[
        "long_name"
    ] = "Minimum y-distance to radar for the convective cell in a track"
    output_data.cell_min_y.attrs["units"] = "km"

    output_data.cell_max_y.attrs[
        "long_name"
    ] = "Maximum y-distance to radar for the convective cell in a track"
    output_data.cell_max_y.attrs["units"] = "km"

    output_data.cell_min_x.attrs[
        "long_name"
    ] = "Minimum x-distance to radar for the convective cell in a track"
    output_data.cell_min_x.attrs["units"] = "km"

    output_data.cell_max_x.attrs[
        "long_name"
    ] = "Maximum x-distance to radar for the convective cell in a track"
    output_data.cell_max_x.attrs["units"] = "km"

    output_data.dilatecell_meanlat.attrs[
        "long_name"
    ] = "Mean latitude of the dilated convective cell in a track"
    output_data.dilatecell_meanlat.attrs["units"] = "degrees_north"

    output_data.dilatecell_meanlon.attrs[
        "long_name"
    ] = "Mean longitude of the dilated convective cell in a track"
    output_data.dilatecell_meanlon.attrs["units"] = "degrees_east"

    output_data.dilatecell_mean_y.attrs[
        "long_name"
    ] = "Mean y-distance to radar for the dilated convective cell in a track"
    output_data.dilatecell_mean_y.attrs["units"] = "km"

    output_data.dilatecell_mean_x.attrs[
        "long_name"
    ] = "Mean x-distance to radar for the dilated convective cell in a track"
    output_data.dilatecell_mean_x.attrs["units"] = "km"

    output_data.core_radius.attrs[
        "long_name"
    ] = "Equivalent radius of the convective core in a track"
    ...
    output_data.cell_radius.attrs[
        "long_name"
    ] = "Equivalent radius of the convective cell in a track"
    ...
    output_data.maxdbz.attrs[
        "long_name"
    ] = "Maximum reflectivity in the convective cell in a track"
    output_data.maxdbz.attrs["units"] = "dBZ"

    output_data.maxETH_10dbz.attrs[
        "long_name"
    ] = "Maximum 10dBZ echo-top height in the convective cell"
    output_data.maxETH_10dbz.attrs["units"] = "km"

    output_data.maxETH_20dbz.attrs[
        "long_name"
    ] = "Maximum 20dBZ echo-top height in the convective cell"
    output_data.maxETH_20dbz.attrs["units"] = "km"

    output_data.maxETH_30dbz.attrs[
        "long_name"
    ] = "Maximum 30dBZ echo-top height in the convective cell"
    output_data.maxETH_30dbz.attrs["units"] = "km"

    output_data.maxETH_40dbz.attrs[
        "long_name"
    ] = "Maximum 40dBZ echo-top height in the convective cell"
    output_data.maxETH_40dbz.attrs["units"] = "km"

    output_data.maxETH_50dbz.attrs[
        "long_name"
    ] = "Maximum 50dBZ echo-top height in the convective cell"
    output_data.maxETH_50dbz.attrs["units"] = "km"

    output_data.cloudnumber.attrs[
        "long_name"
    ] = "Corresponding cloud number in cloudid file in a track"
    output_data.cloudnumber.attrs["units"] = "unitless"
    output_data.cloudnumber.attrs["usage"] = (
        "To link this tracking statistics file with corresponding "
    ...
    output_data.start_split_tracknumber.attrs[
        "long_name"
    ...
    output_data.start_split_timeindex.attrs[
        "long_name"
    ] = "Time index when split occurs"
    output_data.start_split_timeindex.attrs[
        "comments"
    ] = "To connect with the split track, use start_split_tracknumber, start_split_timeindex together"
    output_data.start_split_timeindex.attrs["valid_min"] = 0
    output_data.start_split_timeindex.attrs["valid_max"] = maxtracklength

    output_data.start_split_cloudnumber.attrs[
        "long_name"
    ] = "Cloud number where this track splits from"
    output_data.start_split_cloudnumber.attrs["units"] = "unitless"

    output_data.end_merge_tracknumber.attrs[
        "long_name"
    ...
    output_data.end_merge_timeindex.attrs[
        "comments"
    ] = "To connect with the merge track, use end_merge_tracknumber, end_merge_timeindex together"
    output_data.end_merge_timeindex.attrs["valid_min"] = 0
    output_data.end_merge_timeindex.attrs["valid_max"] = maxtracklength

    output_data.end_merge_cloudnumber.attrs[
        "long_name"
    ] = "Cloud number where this track merges with"
    output_data.end_merge_cloudnumber.attrs["units"] = "unitless"

    output_data.merge_tracknumbers.attrs[
        "long_name"
    ] = "Number of the track that this small cloud merges into"
    output_data.merge_tracknumbers.attrs[
        "usuage"
    ...
    output_data.split_tracknumbers.attrs[
        "long_name"
    ] = "Number of the track that this small cloud splits from"
    output_data.split_tracknumbers.attrs[
        "usuage"
    ...
    output_data.maxrange_flag.attrs[
        "long_name"
    ] = "Flag indicating if tracked cell is at the maximum range of the radar"
    output_data.maxrange_flag.attrs[
        "values"
    ] = "0 = cell outside range mask; 1 = cell within range mask"
    ...
    encodelist = {
        "lifetime": var_int_encode,  #     'basetime': {'zlib':True, 'units': basetime_units}, \
        "basetime": {"zlib": True},
        trackdimname: {"dtype": "int", "zlib": True},
        timedimname: {"dtype": "int", "zlib": True},  # 'cloudidfiles': {'zlib':True}, \
        ...
        "maxrange_flag": var_int_encode,  # 'boundary':  {'dtype': 'int', 'zlib':True, '_FillValue': fillval}, \
        # 'majoraxis': {'zlib':True, '_FillValue': np.nan}, \
        # 'orientation': {'zlib':True, '_FillValue': np.nan}, \
        # 'eccentricity': {'zlib':True, '_FillValue': np.nan}, \
        # 'perimeter': {'zlib':True, '_FillValue': np.nan}, \
